...
def combine_prosody_features(parallel_run_settings):
    '''
    ...
    start = datetime.now()
    wpm.extract_speech_rate(parallel_run_settings=parallel_run_settings)
    ...
    dfs = [wpm_summary, vokaturi_summary_1, vokaturi_summary_2,
